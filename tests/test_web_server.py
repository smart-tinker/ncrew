...
from app.interfaces.web.web_server import app
...
def test_auth_success(client):
    ...
    with patch('app.interfaces.web.web_server.get_roles', return_value=[]):
...
@patch('app.interfaces.web.web_server.save_roles')
